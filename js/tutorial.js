    ...
    const content = `
        ...
        <br/>
            <ol>
                ...
                <li>If your roll matches, all matches will be multiplied together first. Then the remaining numbers will be added. For example, a roll of 1, 3, 3 would be (3 X 3) + 1 = 10. It's possible to get multiple sets of matches. For instance, a roll of 3, 3, 4, 4, 4 would be 3 X 3 X 4 X 4 X 4 = 576.</li>
